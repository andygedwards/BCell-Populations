function [Total_Error,EE_raw_error, TE_raw_error, early_ICa_raw_error, late_ICa_raw_error, peak_INa_raw_error, vhalf_raw_error] = Cost_Function_Combined_multi_out(nTrials, P)

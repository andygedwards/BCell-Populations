function [early_exocytosis, late_exocytosis, total_exocytosis, T, Y] = Exocytosis_plot(parameters, parameter_names, states, state_names, rhs_model, line)
    ...
    try
        outs = analyze_v_clamp_plotting(Y,T,parameters,state_names, cycle_length, prepulse_length, end_length, rhs_model, v_clamp_amps, v_clamp_times, R_clamp, current, plotting, line);
